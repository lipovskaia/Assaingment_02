...
var coinFlip = Math.floor(Math.random() * 50) + 1;

var choice = window.prompt("Enter Heads or Tails");
if (coinFlip >= 25){
    if (choice == "heads"){
        document.write("Number is " + coinFlip + " - The flip was heads and you chose heads...you win!");
    } else {
        document.write("Number is " + coinFlip + " - The flip was heads but you chose tails...you lose!");
    }
    
} else {
    if (choice == "tails"){
        document.write("Number is " + coinFlip + " - The flip was tails and you chose tails...you win!");
    } else {
        document.write("Number is " + coinFlip +  " - The flip was tails but you chose heads...you lose!");
    }
}